...
def dashboard():
    ...
    return render_template("appointment_booking.html",username = username,doctor_name = doctor_name)
...
def submit_appointment():
    ...
    cursor.execute('''
        INSERT INTO appointment (name, illness, phone, email,doctor_name, location, appointment_date, appointment_time)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    ''', (name, illness, phone, email, location, date, time))
